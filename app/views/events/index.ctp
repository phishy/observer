<div class="events index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('event_status_id');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $event['Event']['event_status_id']; ?>&nbsp;</td>
		<td><?php echo $event['Event']['hash']; ?>&nbsp;</td>
		<td><?php echo $event['Event']['job_id']; ?>&nbsp;</td>
		<td><?php echo $event['Event']['message']; ?>&nbsp;</td>
		<td><?php echo $event['Event']['success']; ?>&nbsp;</td>
		<td class="actions">
